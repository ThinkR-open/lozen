---
title: "flat_move_issues_from_gitlab_to_github.Rmd empty"
...
```{r function-move_issues_from_gitlab_to_github}
...
```{r tests-move_issues_from_gitlab_to_github}
...
fusen::inflate(
  flat_file = "dev/flat_move_issues_from_gitlab_to_github.Rmd",
  vignette_name = "bi - Move from GitLab to GitHub",
  overwrite = TRUE,
  check = FALSE,
  document = FALSE,
  open_vignette = FALSE
