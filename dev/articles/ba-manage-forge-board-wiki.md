...
This code prepares the *board* for the *issues*: Issues \> Board \> Add
List

- If the labels are duplicated, go to Issues \> Labels. Delete all the
  “project labels” by clicking on the 3 vertical dots, then Delete. The
  list of labels is now empty, but if you go back to the *board*, you
  will still have the global labels available, in one copy.
