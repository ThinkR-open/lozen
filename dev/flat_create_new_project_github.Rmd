---
title: "Create a new project with GitHub"
...
```{r dev}
# => *This flat file is only used to generate a vignette that explains how to create a new projet with GitHub*. 
# If you need to modify the functions or the unit tests, please go to the dedicated flat file.
```
...
fusen::inflate(
  flat_file = "dev/flat_create_new_project_github.Rmd",
  vignette_name = "ab - Create a new project with GitHub",
  overwrite = TRUE,
  check = FALSE,
  document = FALSE,
  open_vignette = FALSE
