...
- `ad - Build a pkgdown with reports`: Build a pkgdown with coverage and test reports
- `ae - Deploy a {golem} app on Posit Connect and its pkgdown on Gitlab Pages through GitLab CI/CD`: Publish your {golem}-related work
- `af - Deploy a pkgdown on Posit Connect and Gitlab Pages through GitLab CI/CD`: Publish the pkgdown of your R package on Gitlab Pages and Posit Connect
